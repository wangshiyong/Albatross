...
//  Albatross
//
//  Created by wangshiyong on 2017/12/12.
//  Copyright © 2017年 王世勇. All rights reserved.
//

#import "WSYTextField.h"

@interface WSYTextField ()

@property (nonatomic, strong) UIView *tapView;

@end

@implementation WSYTextField

- (void)setTapAcitonBlock:(WSYTapAcitonBlock)tapAcitonBlock {
    _tapAcitonBlock = tapAcitonBlock;
    self.tapView.hidden = NO;
}

- (void)setEndEditBlock:(WSYEndEditBlock)endEditBlock {
