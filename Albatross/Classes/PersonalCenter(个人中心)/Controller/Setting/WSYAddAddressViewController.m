...
{
    WSYTextField *textField = [[WSYTextField alloc]initWithFrame:CGRectMake(100, 0, kScreenWidth - 160, 50)];
...
- (UIButton *)getBtn:(UITableViewCell *)cell
{
    UIButton *btn = [[UIButton alloc]initWithFrame:CGRectMake(kScreenWidth - 45, 13, 24, 24)];
...
- (UITableView *)tableView
{
    if (_tableView == nil) {
        if (iphoneX) {
            _tableView = [[UITableView alloc] initWithFrame:(CGRect){0, 88, kScreenWidth, kScreenHeight - 64} style:UITableViewStyleGrouped];
        } else {
            _tableView = [[UITableView alloc] initWithFrame:(CGRect){0, 64, kScreenWidth, kScreenHeight - 64} style:UITableViewStyleGrouped];
        }
...
- (void)setupAddBtn:(UITableViewCell *)cell
{
    if (!_addBtn) {
        _addBtn = [self getBtn:cell];
    }
}
