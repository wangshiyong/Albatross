...
- (NSArray *)viewControllers {
    ...
    WSYPersonalCenterViewController *secondViewController = [[WSYPersonalCenterViewController alloc] init];
    UIViewController *secondNavigationController = [[WSYNavigationController alloc]
                                                    initWithRootViewController:secondViewController];
    
    WSYPersonalCenterViewController *thirdViewController = [[WSYPersonalCenterViewController alloc] init];
    UIViewController *thirdNavigationController = [[WSYNavigationController alloc]
                                                   initWithRootViewController:thirdViewController];
    
    WSYPersonalCenterViewController *fourthViewController = [[WSYPersonalCenterViewController alloc] init];
    UIViewController *fourthNavigationController = [[WSYNavigationController alloc]
